...
class GoPro(Dataset):
    def __init__(self, data_root , mode="train", interFrames=1, n_inputs=2, ext="png"):
        ...
        videoInputs = [[os.path.join(data_root, f) for f in group] for group in videoInputs]
        self.file_list = videoInputs
    ...
    def __getitem__(self, idx):
        ...
        return images, coords, cells, time_stamps, input_paths
