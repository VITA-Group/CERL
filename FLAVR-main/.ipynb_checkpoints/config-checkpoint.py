...
data_arg.add_argument('--dataset', type=str, default='gopro')
data_arg.add_argument('--data_root', type=str, default='/data/nnice1216/high_FPS_video/GOPRO_Large_all/')
...
model_arg.add_argument('--n_outputs' , type=int, default=7,
...
learn_arg.add_argument("--load_from"  ,type=str , default='/model/nnice1216/video/FLAVR_8x.pth')
