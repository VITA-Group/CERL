...
#                         .permute(0, 2, 1)
                ...
                mask_map = F.sigmoid(F.fold(self.mask_imnet(mask_inp.view(bs * qs, -1)).view(bs, qs, -1).permute(0, 2, 1), output_size=(feat.shape[2], feat.shape[3]), kernel_size=1, padding=0))
                ...
                flows.append(flow_map1.unsqueeze(1))
