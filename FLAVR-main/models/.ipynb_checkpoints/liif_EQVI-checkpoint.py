...
from models.EQVI.AcSloMoS_scope_unet_residual_synthesis_edge_LSE import AcSloMoS_scope_unet_residual_synthesis_edge_LSE as EQVI
...
class LIIF_3d(nn.Module):
    ...
    def __init__(self, encoder_spec, imnet_spec=None,
        ...
        pre_trained_dict = torch.load('/model/nnice1216/video/checkpoints/Stage3_RCSN_RQFP/Stage3_checkpoint.ckpt')['model_state_dict']
    ...
    def gen_feat(self, inp):
        ...
        self.feat = self.encoder(inp[:, :, 0], inp[:, :, 1], inp[:, :, 2], inp[:, :, 3])
