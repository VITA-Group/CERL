...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        self.layer2 = self._make_layer(block, conv_makers[1], 64, layers[1], stride=1, temporal_stride=1)
        self.layer3 = self._make_layer(block, conv_makers[2], 64, layers[2], stride=1, temporal_stride=1)
        self.layer4 = self._make_layer(block, conv_makers[3], 64, layers[3], stride=1, temporal_stride=1)
